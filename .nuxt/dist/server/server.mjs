...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/blog-983185a6.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-e1ebef72.js").then((m) => m.default || m)
  },
  {
    name: "single-id",
    path: "/single/:id",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-fe5a3afb.js").then((m) => m.default || m)
  }
];
